...
\begin{figure*}[t]
	...
	\vspace{-0.5cm}
	\caption{Structure of the proposed LSTM network\vspace{-0.4cm}}
...
\begin{figure*}[t]
	...
	\vspace{-0.5cm}
	\caption{Overview of the overall 2D tracking system\vspace{-0.4cm}}
	\label{fig:tracker}
	\vspace{-0.0cm}
\end{figure*}
...
\subsection{Constraints as penalties}
